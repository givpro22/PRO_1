...
exports.postlogin = exports.postjoin = exports.home = exports.getlogin = exports.getjoin = exports.coffee = exports.Food = exports.CarShare = exports.Bar = void 0;
...
var postjoin = exports.postjoin = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee(req, res) {
    var _req$body, name, email, username, password, password2, location, usernameExists, emailExists;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          _req$body = req.body, name = _req$body.name, email = _req$body.email, username = _req$body.username, password = _req$body.password, password2 = _req$body.password2, location = _req$body.location; // 각각 중복 여부 확인
          _context.next = 3;
